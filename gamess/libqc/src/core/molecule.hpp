...
extern "C" {
    ...
    /**
       @brief Creates the Molecule object
    */
    int Molecule_new(int numAtoms, int *Z, double *r3, double *Q = NULL);

    /**
       @brief Frees the Molecule object
    */
    void Molecule_delete(int molecule);

    /**
       @brief Gets the molecule object
    */
    const Molecule* Molecule_find_object(int molecule);
}
